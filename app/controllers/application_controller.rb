class ApplicationController < ActionController::API
  ...
  # Unauthorized access means credentials are required but absent.
  class AccessUnauthorized < StandardError; end
  # Forbidden access means credentials are insufficient.
  ...
  rescue_from AccessUnauthorized do |exception|
